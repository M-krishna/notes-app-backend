...
func (ec *executionContext) field_Mutation_createNote_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	...
	if tmp, ok := rawArgs["input"]; ok {
		...
		arg0, err = ec.unmarshalOnewNote2ᚖgithubᚗcomᚋMᚑkrishnaᚋnotesᚑappᚑbackendᚋgraphᚋmodelᚐNewNote(ctx, tmp)
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) _Mutation_createNote(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNNote2ᚖgithubᚗcomᚋMᚑkrishnaᚋnotesᚑappᚑbackendᚋgraphᚋmodelᚐNote(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Mutation_deleteNote(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Mutation().DeleteNote(rctx, args["noteId"].(string))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) _Note_user(ctx context.Context, field graphql.CollectedField, obj *model.Note) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNUser2ᚖgithubᚗcomᚋMᚑkrishnaᚋnotesᚑappᚑbackendᚋgraphᚋmodelᚐUser(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Query_notes(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	res := resTmp.([]*model.Note)
	fc.Result = res
	return ec.marshalNNote2ᚕᚖgithubᚗcomᚋMᚑkrishnaᚋnotesᚑappᚑbackendᚋgraphᚋmodelᚐNote(ctx, field.Selections, res)
}
...
func (ec *executionContext) marshalNNote2githubᚗcomᚋMᚑkrishnaᚋnotesᚑappᚑbackendᚋgraphᚋmodelᚐNote(ctx context.Context, sel ast.SelectionSet, v model.Note) graphql.Marshaler {
	return ec._Note(ctx, sel, &v)
}

func (ec *executionContext) marshalNNote2ᚕᚖgithubᚗcomᚋMᚑkrishnaᚋnotesᚑappᚑbackendᚋgraphᚋmodelᚐNote(ctx context.Context, sel ast.SelectionSet, v []*model.Note) graphql.Marshaler {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalONote2ᚖgithubᚗcomᚋMᚑkrishnaᚋnotesᚑappᚑbackendᚋgraphᚋmodelᚐNote(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) marshalNNote2ᚖgithubᚗcomᚋMᚑkrishnaᚋnotesᚑappᚑbackendᚋgraphᚋmodelᚐNote(ctx context.Context, sel ast.SelectionSet, v *model.Note) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "must not be null")
		}
...
func (ec *executionContext) marshalNUser2ᚖgithubᚗcomᚋMᚑkrishnaᚋnotesᚑappᚑbackendᚋgraphᚋmodelᚐUser(ctx context.Context, sel ast.SelectionSet, v *model.User) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "must not be null")
		}
...
func (ec *executionContext) marshalONote2ᚖgithubᚗcomᚋMᚑkrishnaᚋnotesᚑappᚑbackendᚋgraphᚋmodelᚐNote(ctx context.Context, sel ast.SelectionSet, v *model.Note) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
	return ec._Note(ctx, sel, v)
...
func (ec *executionContext) unmarshalOnewNote2ᚖgithubᚗcomᚋMᚑkrishnaᚋnotesᚑappᚑbackendᚋgraphᚋmodelᚐNewNote(ctx context.Context, v interface{}) (*model.NewNote, error) {
	if v == nil {
		return nil, nil
	}
